...
stateDiagram-v2
    [*] --> NORMALモード
    NORMALモード --> INSERTモード: i
    INSERTモード --> NORMALモード: Escキー
    NORMALモード --> VISUALモード: v
    VISUALモード --> NORMALモード: Escキー
    NORMALモード --> COMMANDモード: collonキー
    COMMANDモード --> NORMALモード: Escキー
    NORMALモード --> TERMINALモード: Ctrl-/
    TERMINALモード --> NORMALモード: Ctrl-d
    NORMALモード --> [*]
```
...
## 1.7. 大きなサイズのテキストの編集および複数ファイルの編集
...
## 1.11. 基本的な略語、キーボード割り当て、初期設定ファイル
...
## 1.17. ファイル回復とコマンドライン引数

## 1.18. その他のコマンド

## 1.19. 操作方法

## 1.20. 本書で分類されていないトピックス
