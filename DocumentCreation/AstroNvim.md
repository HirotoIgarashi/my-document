...
<!-- mtoc-start -->
  ...
  * [AstroNvimとは](#astronvimとは)
  * [パソコン用のエディター](#パソコン用のエディター)
    * [Linuxのエディターとして設定する場合](#linuxのエディターとして設定する場合)
  * [GettingStarted - AstroNvimを始めよう](#gettingstarted---astronvimを始めよう)
    * [AstroNvimのインストール](#astronvimのインストール)
    * [AstroNvimの特徴](#astronvimの特徴)
    * [AstroNvimの要件](#astronvimの要件)
    * [AstroNvimのインストール](#astronvimのインストール-1)
    * [Astronvimのセットアップ](#astronvimのセットアップ)
      * [LSPのイントール](#lspのイントール)
      * [言語パーサー(language parser)のイントール](#言語パーサーlanguage-parserのイントール)
      * [デバッガ(language parser)のイントール](#デバッガlanguage-parserのイントール)
      * [プラグインの管理](#プラグインの管理)
      * [AstroNvimの更新](#astronvimの更新)
      * [AstroNvimパッケージの更新](#astronvimパッケージの更新)
      * [Reload AstroNvim (EXPERIMENTAL)](#reload-astronvim-experimental)
    * [コンフィグレーション](#コンフィグレーション)
  * [AstroCommunity - AstroCommunityを使おう](#astrocommunity---astrocommunityを使おう)
  * [Mappings - キーマッピング](#mappings---キーマッピング)
    * [Opening LSP symbols](#opening-lsp-symbols)
    * [行の診断結果を確認する](#行の診断結果を確認する)
    * [Hover document](#hover-document)
    * [Open rename prompt](#open-rename-prompt)
    * [Go to definition](#go-to-definition)
    * [Code actions](#code-actions)
    * [Telescope search](#telescope-search)
    * [Telescope grep](#telescope-grep)
    * [Telescope git status](#telescope-git-status)
    * [Telescope old files](#telescope-old-files)
    * [Which key](#which-key)
    * [標準のマッピング](#標準のマッピング)
    * [バッファー](#バッファー)
    * [Better Escape](#better-escape)
    * [補完（Completion）](#補完completion)
    * [Neo-Tree](#neo-tree)
    * [Dashboard Mappings](#dashboard-mappings)
    * [Session Manager Mappings](#session-manager-mappings)
    * [Package Management Mappings](#package-management-mappings)
    * [LSP Mappings](#lsp-mappings)
    * [Debugger Mappings](#debugger-mappings)
    * [Telescope Mappings](#telescope-mappings)
    * [Terminal Mappings](#terminal-mappings)
    * [UI/UX Mappings](#uiux-mappings)
  * [Using This Documentation - この文書を使う](#using-this-documentation---この文書を使う)
  * [configuration - 構成](#configuration---構成)
    * [Core Plugins](#core-plugins)
    * [Customizing Plugins](#customizing-plugins)
      * [Defining Plugins](#defining-plugins)
      * [Configure AstroNvim Plugins](#configure-astronvim-plugins)
      * [How opts Overriding Works](#how-opts-overriding-works)
      * [Extending Core Plugin Config Functions](#extending-core-plugin-config-functions)
      * [Disabling Plugins](#disabling-plugins)
      * [Lazy Loading](#lazy-loading)
      * [Lazy Loading with AstroCore](#lazy-loading-with-astrocore)
      * [Lazy Load File Related Plugins](#lazy-load-file-related-plugins)
      * [Lazy Load Git Plugins](#lazy-load-git-plugins)
    * [Lua language Server integration](#lua-language-server-integration)
    * [Managing User Configuration](#managing-user-configuration)
  * [Recipes - レシピ](#recipes---レシピ)
  * [リファレンス](#リファレンス)
    * [Alternative Installation](#alternative-installation)
    * [Exposed Autocommands](#exposed-autocommands)
    * [Contributing to AstroNvim](#contributing-to-astronvim)
    * [Default Plugins](#default-plugins)
    * [uninstall AstroNvim](#uninstall-astronvim)
  * [Acknowledgements - レシピ](#acknowledgements---レシピ)
  * [Code of Conduct](#code-of-conduct)
    * [ユーザ構成の管理](#ユーザ構成の管理)
    * [公開された自動コマンド](#公開された自動コマンド)
    * [設定メカニズム](#設定メカニズム)
    * [利用可能なユーザーオプション](#利用可能なユーザーオプション)
* [:checkhealthで動作環境をチェックする](#checkhealthで動作環境をチェックする)
  * [astrocore](#astrocore)
  * [astronvim](#astronvim)
  * [blink.cmp](#blinkcmp)
  * [System](#system)
    ...
    * [git](#git)
    * [?](#)
    * [blink_cmp_fuzzy](#blink_cmp_fuzzy)
  * [Source](#source)
  * [Default source](#default-source)
  * [Cmdline source](#cmdline-source)
  * [Disabled source](#disabled-source)
  * [Lazy](#lazy)
    * [Lazy.nvim](#lazynvim)
    * [luarocks](#luarocks)
  * [mason](#mason)
    * [mason.nvim](#masonnvim)
    * [mason.nvim [Registries]](#masonnvim-registries)
    * [mason.nvim [Core utils]](#masonnvim-core-utils)
    * [mason.nvim [Languages]](#masonnvim-languages)
  * [nvim-treesitter](#nvim-treesitter)
  * [Installation](#installation)
  * [snacks](#snacks)
    * [Snacks](#snacks-1)
    * [Snacks.bigfile](#snacksbigfile)
    * [Snacks.dashboard](#snacksdashboard)
  * [vim.deprecated](#vimdeprecated)
  * [vim.health](#vimhealth)
  * [Configuration](#configuration)
  * [Runtime](#runtime)
  * [Performance](#performance)
  * [Remote Plugins](#remote-plugins)
  * [terminal](#terminal)
  * [External Toolsterminal](#external-toolsterminal)
